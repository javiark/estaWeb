...
const amplaciones = [
    {
        id: 1,
        name: "Exteriores",
        img: "/assets/images/Renders/Exteriores.jpg"

    },
    {
        id: 2,
        name: "Interiores",
        img: "/assets/images/Renders/Interiores.jpg"
    }
...
amplaciones.map((x1) => {
    ...
    <div class="card">
          <a id="${x1.id}" onmouseover="titleShow(${x1.id})" onmouseout="resetTitle(${x1.id})" class="card__imgCont" href="/pages/areas/${x1.name}.html">
